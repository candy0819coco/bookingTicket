...
import "./TicketOrderSuccess.scss";
import * as R from "ramda";
import context, { Provider } from "../context";

const TicketOrderSuccess = (props) => {
  ...
  return (
    <div className={`ticket_order_success_container`}>
      <div className={`ticket_order_success`}>

        <div className={`ticket_order_success_content_container`}>
