              ...
              >
                ...
                >
                  {currentHoverTicketType === "one" ? (
                    <div className={`content ${isDarkMode  ? "content_dark":""}`}>
                      ...
                      <div className="sub_rule">
                        ...
                        指定效期區間 2022-08-13 ~ 2022-08-14<br />逾期失效。
                        <br />
                      </div>
                      <p>
                  ...
                  {currentHoverTicketType === "camp" ? (
                    <div className={`content ${isDarkMode ? "content_dark":""}`}>
                      ...
                      <p>
                        ...
                        <li>場地四週皆有水源及流動廁所，不提供電源，有接泊車來回接送。</li>
                        <li>Love & Peace Rock Festival活動主辦單位保有活動最終解釋權，所有活動、節目異動請詳官方訊息。</li>
