...
class MyMarker extends Component {
    state = {
        class: [
            { id: 1, class: 'markerSetting camp1Marker',talk:'Sage 1' },
            { id: 2, class: 'markerSetting camp2Marker',talk:'營地'},
            { id: 3, class: 'markerSetting camp3Marker',talk:'Stage 2' },
            { id: 4, class: 'markerSetting camp4Marker',talk:'Stage 3' },
            { id: 5, class: 'markerSetting camp5Marker',talk:'營地' },
            { id: 6, class: 'markerSetting camp6Marker' ,talk:'營地'},
