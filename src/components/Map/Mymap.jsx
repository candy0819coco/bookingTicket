...
var position = [24.9332043,121.5409237]
  ...
  render() {
    return (
      ...
      <div className='container d-flex flex-wrap outsideCon' >
        <div className='title'>
          <img className='traffic' src="https://media.discordapp.net/attachments/677538517949218820/943334546525540382/Traffic.png" alt="" />
          <img className='toEvent' onClick={this.trfficHandleClick} src="https://media.discordapp.net/attachments/677538517949218820/943334546764595280/toEvent.png" alt="" />
        </div>
