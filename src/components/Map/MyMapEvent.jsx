        ...
        return (
            <div>
                <div className='d-flex eventMap hide'>
                    ...
                    <div className='test '>
                        <img className='mapTag' src="https://media.discordapp.net/attachments/677538517949218820/942965013881167882/mapTag.png" alt="" />
                        <img className='toOutside' onClick={this.handleClick} src="https://media.discordapp.net/attachments/677538517949218820/942965013403037767/outside.png" alt="" />
                        <div className='bla'>
